...
def engineer_gentrification_features(df):
    ...
    Input:
        df: pandas dataframe with rent, income, and property value data. Must contain:
        ...
        Optional columns (function adapts based on availability):
            ...
            Borough columns: borough_brooklyn, borough_queens, borough_manhattan
    ...
    column_groups = {
        ...
        'borough': ['borough_brooklyn','borough_manhattan','borough_queens']
    }
    ...
    # borough categorical variables are constant
    for col in available_columns['borough']:
        agg_dict[col] = 'first'
