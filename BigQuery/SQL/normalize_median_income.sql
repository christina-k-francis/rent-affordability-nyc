--- Refresh script that calculates a normalized table that stems from the staging_median_income table

--- Creating the fact_median_income table from the recently updated staging_median_rent table
